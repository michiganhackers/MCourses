...
//                            .foregroundColor(Color(red: 0.60, green: 0.61, blue: 0.59))
            ...
            List {
                ScrollView {
                    ClassView(course: Course(name: "EECS 183: Elementary Programming Concepts"))
                    ClassView(course: Course(name: "EECS 203: Discrete Mathemattics"))
                    ClassView(course: Course(name: "EECS 280: Programming and Intro Data Structures"))
                    ClassView(course: Course(name: "EECS 281: Data Structures and Algorithms"))
                    ClassView(course: Course(name: "EECS 370: Intro to Computer Organization"))
                    ClassView(course: Course(name: "EECS 376: Foundations of Computer Science"))
